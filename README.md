...
- 2026-08-02 重新运行 Godot 发布门禁为 2,959/2,959 通过，0 失败；移动后迷雾即时刷新、真实鼠标结束回合、中键拖动镜头、右键移动快捷键、自动选中玩家单位、攻击范围提示、角色详情面板、对话布局和两个选项的真实鼠标输入均已通过回归契约。Windows 发布包在 200% 系统缩放下已核验为完整 1280×720 内容布局。
