...
var base_url: String = "http://localhost:3001/api"
...
func get_campaign() -> Dictionary:
	return await _get("/maps/campaign")

## 获取关卡详情
func get_level(level_id: String) -> Dictionary:
	return await _get("/maps/" + level_id)
...
func download_save(save_id: String) -> Dictionary:
	return await _get("/saves/" + save_id)
