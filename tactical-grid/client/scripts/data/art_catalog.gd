...
const PATHS := {
	...
	&"unit": {
		&"assault": ROOT + "units/assault_topdown_64.png",
		&"sniper": ROOT + "units/sniper_topdown_64.png",
		&"heavy": ROOT + "units/heavy_topdown_64.png",
		&"medic": ROOT + "units/medic_topdown_64.png",
		&"scout": ROOT + "units/scout_topdown_64.png",
		&"attack_drone": ROOT + "units/attack_drone_topdown_64.png",
		&"drone_scout": ROOT + "units/attack_drone_topdown_64.png",
		&"drone_assault": ROOT + "units/attack_drone_topdown_64.png",
		&"drone_bomber": ROOT + "units/attack_drone_topdown_64.png",
		&"cyber_guard": ROOT + "units/cyber_guard_64.png",
		&"sentry_basic": ROOT + "units/cyber_guard_64.png",
		&"sentry_elite": ROOT + "units/cyber_guard_64.png",
		&"sentry_sniper": ROOT + "units/cyber_guard_64.png",
