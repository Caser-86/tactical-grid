...
$sfx = @(
    ...
    @('sfx/sfx_combat_shotgun.wav', 96.0, 0.26),
    @('sfx/sfx_combat_smg.wav', 280.0, 0.13),
    @('sfx/sfx_combat_blade.wav', 640.0, 0.16),
    @('sfx/sfx_combat_sniper.wav', 118.0, 0.34),
    @('sfx/sfx_combat_machine_gun.wav', 145.0, 0.22),
    @('sfx/sfx_combat_launcher.wav', 68.0, 0.38),
    @('sfx/sfx_combat_medical.wav', 540.0, 0.28),
