...
> status: M103 passed; M104 rescue integration next
...
P1、P2、M101-M103 已完成。下一步执行 `docs/superpowers/plans/2026-08-05-v2-p3-p5-m1-vertical-slice.md` 的 M104，实现侦察兵相邻营救、同关加入、行动预算注册和立即可选。M1 未通过 H1 三名首次玩家门前，不扩展后续章节正式内容。
