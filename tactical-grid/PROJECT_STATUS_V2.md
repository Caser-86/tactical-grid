...
> status: M106 passed; M107 stealth next
...
- M107-M114：M1 潜伏警戒、教学、失败重试、基地成长、对话、自动 E2E、首次玩家记录和 H1 修正。
...
P1、P2、M101-M106 已完成。下一步执行 `docs/superpowers/plans/2026-08-05-v2-p3-p5-m1-vertical-slice.md` 的 M107，实现潜伏/搜索警戒状态、即时迷雾后果和可读的警戒反馈。M1 未通过 H1 三名首次玩家门前，不扩展后续章节正式内容。
