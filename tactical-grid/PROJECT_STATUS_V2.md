...
> status: M107 passed; M108 tutorial next
...
- M108-M114：M1 教学、失败重试、基地成长、对话、自动 E2E、首次玩家记录和 H1 修正。
...
P1、P2、M101-M107 已完成。下一步执行 `docs/superpowers/plans/2026-08-05-v2-p3-p5-m1-vertical-slice.md` 的 M108，实现六步行为教学，让新玩家在不读文档的情况下完成选择、移动、攻击、读意图、摄像头和撤离。M1 未通过 H1 三名首次玩家门前，不扩展后续章节正式内容。
