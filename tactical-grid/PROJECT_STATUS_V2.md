...
> status: M111 passed; M112 E2E next
...
- M112-M114：M1 自动 E2E、首次玩家记录和 H1 修正。
...
P1、P2、M101-M111 已完成。下一步执行 `docs/superpowers/plans/2026-08-05-v2-p3-p5-m1-vertical-slice.md` 的 M112，建立从新档到 M2 解锁、可选记录和检查点重试的三条真实 E2E，并输出 M1 灰盒视觉矩阵。M1 未通过 H1 三名首次玩家门前，不扩展后续章节正式内容。
